...
namespace Sales.Infraestructure.DAO
{
    public class RoleMenuDb : DaoBase<RoleMenu>, IRoleMenuDb
    {
        ...
        public List<RoleMenuModel> GetRoleMenus()
        {
            throw new NotImplementedException();
        }

        public List<RoleMenuModel> GetRoleMenusByDates(DateTime startDate, DateTime endDate)
        {
            throw new NotImplementedException();
        }
        ...
        public List<RoleMenuModel> GetRoleMenusCount()
        {
            throw new NotImplementedException();
        }
