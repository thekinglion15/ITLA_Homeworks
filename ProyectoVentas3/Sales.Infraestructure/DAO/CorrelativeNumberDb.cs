...
namespace Sales.Infraestructure.DAO
{
    public class CorrelativeNumberDb : DaoBase<CorrelativeNumber>, ICorrelativeNumberDb
    {
        ...
        public List<CorrelativeNumberModel> GetCorrelativeNumbers()
        {
            throw new NotImplementedException();
        }

        public List<CorrelativeNumberModel> GetCorrelativeNumbersByDates(DateTime startDate, DateTime endDate)
        {
            throw new NotImplementedException();
        }
        ...
        public List<CorrelativeNumberModel> GetCorrelativeNumbersCount()
        {
            throw new NotImplementedException();
        }
