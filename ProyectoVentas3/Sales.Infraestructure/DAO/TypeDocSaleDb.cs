...
namespace Sales.Infraestructure.DAO
{
    public class TypeDocSaleDb : DaoBase<TypeDocSale>, ITypeDocSaleDb
    {
        ...
        public List<TypeDocSaleModel> GetTypeDocSales()
        {
            throw new NotImplementedException();
        }

        public List<TypeDocSaleModel> GetTypeDocSalesByDates(DateTime startDate, DateTime endDate)
        {
            throw new NotImplementedException();
        }
        ...
        public List<TypeDocSaleModel> GetTypeDocSalesCount()
        {
            throw new NotImplementedException();
        }
